...
async function get (request, reply) {
    ...
    let sql = `SELECT * FROM web_todo WHERE user_id = ?`;
...
async function show (request, reply) {
    ...
    let token = request.headers.authorization;
    let check = await header.check(token, reply);
    let sql = `SELECT * FROM web_todo WHERE id = ? AND user_id = ?`;
...
async function store (request, reply) {
    ...
    let check = await header.check(token, reply);
    let sql = `INSERT INTO web_todo (user_id, title, description, created_at, updated_at) values(?, ?, ?, ?, ?)`;
...
async function update (request, reply) {
    ...
    let check = await header.check(token, reply);
    let sql = `UPDATE web_todo set title = ?, description = ?, updated_at = ?) values(?, ?, ?) WHERE id = ? AND user_id = ?`;
...
async function destroy (request, reply) {
    ...
    let token = request.headers.authorization;
    let check = await header.check(token, reply);
    let sql = `DELETE FROM web_todo WHERE id = ? AND user_id = ?`;
